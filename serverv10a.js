// lesson10-blog handling routes for CRD
//    uses additional express middleware :express.urlencodes
// lesson 9 - mongodb
...
//lesson10 - route parameter

const htmlViewBlog = require("./routes/viewBlog.js");
...
server.get("/blogs/:id",(req,res)=>{
  ...
  //call model async findOne
  Blog.findById(id)
  .then((result)=>{ 
    console.log(result);
    htmlViewBlog(req,res,result);
  }
  )
  .catch((e)=>{
    console.log(e.message);
